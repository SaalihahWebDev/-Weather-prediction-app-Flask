...
def get_weather():
    ...
    if not city or not validate_city_name(city):
        return render_template("index.html",error="Please enter a valid coity name")
    ...
    if response.status_code==200:
        ...
        weather={
            ...
            "humidhity":data["main"]["humidhity"],
            "wind_speed":data["wind"]["speed"],
            "icon":f"http://openweathermap.ord/img/wn/{data['weather'][0]["icon"]}@2x.png"
        }
